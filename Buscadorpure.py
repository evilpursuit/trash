...
if __name__ == "__main__":
    ...
    window = tk.Tk()
    window.title("Licença expirada - Entre em contato com 41995999175 via WhatsApp para uma cópia original <AssemblyName>") #Licença expirada - Entre em contato com 41995999175 via WhatsApp para uma cópia original 
    ...
    ttk.Label(window, text="ENTRE EM CONTATO COM 41-995999175 PARA OBTER UMA CÓPIA ORIGINAL").pack(pady=10) #ENTRE EM CONTATO COM 41-995999175 PARA OBTER UMA CÓPIA ORIGINAL
